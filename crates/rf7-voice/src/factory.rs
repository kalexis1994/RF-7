...
fn brass() -> Voice {
    voice(
        ...
        7,
        [
            op([62, 40, 45, 55], [99, 90, 88, 0], 99, 1, 7, 5),
            op([58, 38, 44, 54], [99, 88, 86, 0], 98, 1, 9, 5),
            op([55, 42, 40, 52], [99, 78, 70, 0], 96, 1, 6, 6),
            op([60, 40, 44, 54], [99, 86, 84, 0], 94, 2, 5, 5),
            op([56, 36, 42, 52], [99, 84, 80, 0], 80, 1, 10, 4),
            op([52, 40, 38, 50], [99, 70, 62, 0], 88, 1, 8, 6),
        ],
    )
}
...
fn organ() -> Voice {
    voice(
        ...
        [
            ...
            op([88, 50, 45, 70], [99, 95, 95, 0], 86, 2, 7, 2),
            op([88, 50, 45, 70], [99, 95, 95, 0], 76, 3, 7, 2),
            op([88, 50, 45, 70], [99, 95, 95, 0], 68, 4, 7, 2),
...
fn sub_bass() -> Voice {
    octave_down(voice(
        ...
        [
            ...
            struck(op([99, 50, 40, 68], [99, 90, 80, 0], 98, 0, 7, 2), 1),
    ...
    pitch_envelope(
        lfo(
            voice(
                ...
                7,
                [
                    op([60, 40, 45, 55], [99, 88, 85, 0], 99, 1, 7, 4),
                    op([58, 42, 40, 52], [99, 75, 68, 0], 94, 1, 9, 6),
                    op([58, 38, 44, 54], [99, 86, 84, 0], 94, 1, 5, 4),
                    op([62, 40, 44, 54], [99, 86, 84, 0], 90, 1, 10, 4),
                    op([56, 36, 42, 52], [99, 84, 80, 0], 80, 2, 6, 3),
                    op([54, 44, 40, 50], [99, 72, 64, 0], 90, 1, 8, 6),
                ],
            ),
            34,
            30,
        ...
        lfo(
            voice(
                ...
                [
                    ...
                    op([66, 48, 42, 55], [99, 78, 70, 0], 96, 1, 8, 7),
                    op([68, 44, 48, 56], [99, 85, 82, 0], 66, 1, 6, 4),
                    op([64, 50, 44, 54], [99, 70, 60, 0], 80, 1, 7, 6),
                    op([62, 52, 44, 54], [99, 65, 55, 0], 70, 2, 9, 6),
                    op([60, 55, 45, 54], [99, 60, 50, 0], 74, 1, 7, 6),
                ],
            ),
            36,
            35,
...
fn sax() -> Voice {
    lfo(
        voice(
            ...
            7,
            [
                op([72, 40, 45, 58], [99, 88, 85, 0], 99, 1, 7, 5),
                op([68, 45, 40, 55], [99, 74, 66, 0], 94, 1, 9, 7),
                op([70, 38, 44, 56], [99, 86, 82, 0], 90, 1, 5, 5),
                op([75, 50, 42, 56], [99, 60, 50, 0], 76, 2, 7, 7),
                op([66, 46, 40, 54], [99, 70, 62, 0], 82, 1, 8, 6),
                op([80, 55, 45, 58], [99, 55, 40, 0], 80, 3, 7, 6),
            ],
        ),
        38,
        40,
...
fn strings() -> Voice {
    lfo(
        voice(
            ...
            6,
            [
                op([50, 30, 40, 48], [99, 90, 88, 0], 99, 1, 5, 3),
                op([52, 35, 38, 46], [99, 70, 64, 0], 84, 1, 9, 5),
                op([48, 28, 40, 48], [99, 88, 86, 0], 98, 1, 10, 3),
...
fn pad() -> Voice {
    lfo(
        voice(
            ...
            4,
            [
                op([40, 25, 35, 42], [99, 92, 90, 0], 99, 1, 4, 2),
                op([38, 24, 35, 42], [99, 92, 90, 0], 96, 1, 11, 2),
                op([42, 30, 32, 40], [99, 70, 62, 0], 86, 2, 7, 4),
                op([36, 22, 34, 40], [99, 90, 88, 0], 92, 1, 7, 2),
...
fn choir() -> Voice {
    lfo(
        voice(
            ...
            5,
            [
                tremolo(op([45, 30, 40, 44], [99, 90, 88, 0], 96, 1, 7, 2), 1),
                tremolo(op([44, 30, 40, 44], [99, 88, 86, 0], 90, 2, 9, 2), 1),
                op([46, 30, 40, 44], [99, 84, 80, 0], 82, 3, 5, 2),
                op([42, 28, 40, 44], [99, 86, 84, 0], 86, 1, 10, 2),
                op([43, 28, 40, 44], [99, 82, 78, 0], 76, 4, 6, 2),
...
fn pipe() -> Voice {
    voice(
        ...
        6,
        [
            op([70, 40, 45, 60], [99, 92, 90, 0], 99, 1, 7, 1),
            op([68, 40, 45, 60], [99, 88, 86, 0], 88, 2, 7, 1),
            op([66, 40, 45, 60], [99, 80, 78, 0], 72, 4, 7, 1),
            op([72, 40, 45, 60], [99, 76, 74, 0], 62, 0, 7, 1),
            op([95, 60, 45, 60], [99, 60, 55, 0], 76, 3, 7, 2),
    ...
    lfo(
        voice(
            ...
            [
                ...
                op([99, 50, 45, 60], [99, 88, 86, 0], 96, 1, 4, 4),
                op([99, 50, 45, 60], [99, 88, 86, 0], 96, 1, 10, 4),
                op([99, 50, 45, 60], [99, 86, 84, 0], 86, 2, 7, 3),
    ...
    lfo(
        voice(
            ...
            [
                ...
                op([99, 45, 45, 58], [99, 80, 78, 0], 66, 1, 9, 3),
