        ...
        lfo(
            voice(
                ...
                [
                    ...
                    op([48, 40, 30, 60], [96, 92, 90, 0], 60, 1, 7, 1),
...
fn sax() -> Voice {
    lfo(
        voice(
            ...
            7,
            [
                op([72, 40, 45, 58], [99, 95, 94, 0], 99, 1, 7, 5),
                op([68, 45, 40, 55], [99, 74, 66, 0], 94, 1, 9, 7),
                op([70, 38, 44, 56], [99, 95, 94, 0], 90, 1, 5, 5),
...
fn strings() -> Voice {
    lfo(
        voice(
            ...
            6,
            [
                op([50, 30, 40, 48], [99, 95, 94, 0], 99, 1, 5, 3),
                op([52, 35, 38, 46], [99, 70, 64, 0], 84, 1, 9, 5),
                op([48, 28, 40, 48], [99, 95, 94, 0], 98, 1, 10, 3),
...
fn pad() -> Voice {
    lfo(
        voice(
            ...
            4,
            [
                op([40, 25, 35, 42], [99, 95, 94, 0], 99, 1, 4, 2),
                op([38, 24, 35, 42], [99, 95, 94, 0], 96, 1, 11, 2),
                op([42, 30, 32, 40], [99, 70, 62, 0], 86, 2, 7, 4),
                op([36, 22, 34, 40], [99, 95, 94, 0], 92, 1, 7, 2),
...
fn pipe() -> Voice {
    voice(
        ...
        6,
        [
            op([70, 40, 45, 60], [99, 95, 94, 0], 99, 1, 7, 1),
            op([68, 40, 45, 60], [99, 95, 94, 0], 88, 2, 7, 1),
            op([66, 40, 45, 60], [99, 94, 94, 0], 72, 4, 7, 1),
            op([72, 40, 45, 60], [99, 94, 94, 0], 62, 0, 7, 1),
            op([95, 60, 45, 60], [99, 95, 94, 0], 76, 3, 7, 2),
...
fn lead() -> Voice {
    lfo(
        voice(
            ...
            7,
            [
                op([99, 50, 45, 60], [99, 95, 96, 0], 99, 1, 7, 4),
                op([99, 55, 45, 60], [99, 80, 75, 0], 99, 1, 8, 6),
                op([99, 50, 45, 60], [99, 94, 96, 0], 96, 1, 6, 4),
                op([99, 50, 45, 60], [99, 94, 96, 0], 93, 1, 8, 4),
...
fn square() -> Voice {
    lfo(
        voice(
            ...
            7,
            [
                op([99, 45, 45, 58], [99, 96, 96, 0], 99, 1, 7, 3),
                op([99, 50, 45, 58], [99, 82, 78, 0], 98, 2, 7, 5),
                op([99, 45, 45, 58], [99, 94, 95, 0], 66, 1, 9, 3),
