...
fn piano() -> Voice {
    voice(
        ...
        6,
        [
            // The prompt sound: falls away fast, faster up the keyboard.
            struck(
                scaled(
                    op([90, 31, 24, 50], [99, 0, 0, 0], 99, 1, 5, 2),
                    0,
                    80,
                    0,
                    3,
            ...
            struck(
                scaled(
                    op([98, 20, 20, 40], [99, 92, 85, 0], 84, 1, 9, 2),
                    20,
                    0,
                    10,
                    0,
            ...
            struck(
                scaled(
                    op([84, 25, 25, 15], [99, 99, 99, 0], 54, 3, 7, 1),
                    47,
                    0,
                    25,
                    0,
            ...
            // The aftersound: a slow tail at every key, quieter up the keyboard.
            struck(
                scaled(
                    op([88, 18, 18, 45], [99, 0, 0, 0], 94, 1, 8, 2),
                    14,
                    24,
                    25,
                    3,
            ...
            struck(
                scaled(
                    fine(op([84, 58, 36, 40], [99, 14, 0, 0], 92, 1, 6, 3), 58),
                    48,
                    0,
                    66,
                    0,
            ...
            struck(
                scaled(
                    op([99, 20, 25, 40], [99, 88, 78, 0], 78, 1, 6, 0),
                    30,
                    0,
                    10,
                    0,
...
fn grand() -> Voice {
    voice(
        ...
        4,
        [
            // The prompt sound under the 7:1 hammer; the aftersound under
            // the half-ratio thump.
            struck(
                scaled(
                    op([90, 33, 24, 45], [99, 0, 0, 0], 99, 1, 4, 2),
                    0,
                    70,
                    0,
                    3,
            ...
            struck(
                scaled(
                    op([98, 36, 8, 32], [92, 90, 0, 0], 80, 1, 10, 0),
                    50,
                    20,
                    30,
                    3,
            ...
            struck(
                scaled(
                    op([94, 78, 20, 14], [84, 66, 0, 0], 86, 7, 5, 1),
                    43,
                    25,
                    30,
                    3,
            ...
            struck(
                scaled(
                    op([88, 18, 18, 45], [99, 0, 0, 0], 92, 1, 10, 2),
                    14,
                    24,
                    28,
                    3,
            ...
            struck(
                scaled(
                    op([98, 22, 8, 4], [92, 90, 0, 0], 82, 1, 6, 0),
                    41,
                    15,
                    20,
                    3,
            ...
            struck(
                scaled(
                    op([82, 72, 16, 12], [99, 20, 0, 0], 70, 0, 8, 2),
                    53,
                    0,
                    0,
                    0,
...
fn upright() -> Voice {
    octave_down(voice(
        ...
        5,
        [
            // The aftersound under a soft 1:1; the prompt sound under a 5:1
            // hammer and a half-ratio thump with the feedback loop.
            struck(
                scaled(
                    op([88, 18, 18, 45], [99, 0, 0, 0], 92, 1, 7, 2),
                    14,
                    24,
                    25,
                    3,
            ...
            struck(
                scaled(
                    op([96, 14, 20, 30], [99, 95, 0, 0], 94, 1, 9, 1),
                    0,
                    0,
                    12,
                    0,
            ...
            struck(
                scaled(
                    op([84, 31, 24, 50], [99, 0, 0, 0], 99, 1, 7, 2),
                    0,
                    60,
                    0,
                    3,
            ...
            struck(
                scaled(
                    op([90, 40, 20, 50], [99, 60, 0, 0], 82, 5, 8, 2),
                    32,
                    0,
                    55,
                    0,
            ...
            struck(
                scaled(
                    op([97, 28, 12, 25], [99, 86, 48, 0], 90, 1, 6, 1),
                    40,
                    15,
                    40,
                    3,
            ...
            struck(
                scaled(
                    op([92, 70, 58, 36], [99, 0, 0, 0], 68, 0, 8, 1),
                    36,
                    0,
                    90,
                    0,
